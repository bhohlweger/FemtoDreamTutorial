...
#ifndef PWGCF_FEMTOSCOPY_FEMTODREAM_ALIANALYSISTASKFEMTOTUTORIAL_H_
#define PWGCF_FEMTOSCOPY_FEMTODREAM_ALIANALYSISTASKFEMTOTUTORIAL_H_
#include "Rtypes.h"
...
class AliAnalysisTaskFemtoTutorial : public AliAnalysisTaskSE {
 public:
  AliAnalysisTaskFemtoTutorial();
  AliAnalysisTaskFemtoTutorial(const char *name, bool isMC);
  virtual ~AliAnalysisTaskFemtoTutorial();
